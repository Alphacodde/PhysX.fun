...
const FLOATING_SYMBOLS = [
  { symbol: 'E=mc²', x: 10, y: 20, delay: 0, size: 'text-2xl' },
  { symbol: 'ħ', x: 85, y: 15, delay: 1, size: 'text-3xl' },
  { symbol: 'Ψ', x: 25, y: 80, delay: 2, size: 'text-4xl' },
  { symbol: '∇²', x: 90, y: 75, delay: 3, size: 'text-2xl' },
  { symbol: 'λ', x: 15, y: 50, delay: 4, size: 'text-3xl' },
  { symbol: '∫', x: 75, y: 25, delay: 5, size: 'text-2xl' },
  { symbol: 'δ', x: 45, y: 10, delay: 6, size: 'text-3xl' },
  { symbol: '∞', x: 60, y: 85, delay: 7, size: 'text-2xl' },
];

const PhysicsPage = () => {
  // Fetch mathematics posts from Sanity
  const posts: Post[] = useSanity(`*[_type == "post" && category->title == "Physics"]{
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white overflow-hidden">
      ...
      >
        ...
        >
          ...
          <div className="relative flex items-center gap-3">
            <span>Discover The Physical Magic</span>
            <motion.div
              animate={{ x: [0, 5, 0] }}
              transition={{ 
                duration: 1.5,
      ...
      <section id="physics-articles" className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
          ...
          <div className="lg:col-span-2">
            {featuredPost ? (
              ...
              >
                ...
                <p className="text-slate-400 text-lg">Loading featured physics article...</p>
              </motion.div>
            )}
          </div>
